# NBA 2K26 Player Progression System
...
As part of my Python programming journey, I decided to take [u/rustyhwe's](https://www.reddit.com/user/rustyhwe/) logic and build it into a web-based tracker using Python and Flask. This version, **NBA 2K26 Player Progression Tracker**, includes extended features, a better user interface, and more customization options.
